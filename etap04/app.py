...
- Body size: (samce): {avg_body_size:.2f}
- Orange area: (samce): {avg_orange_area:.2f}
- Black area: (samce): {avg_black_area:.2f}
...
- Zgony drapieżników (ostatni krok): {model.predator_deaths_last_step}
